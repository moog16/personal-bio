...
const Headshot = (props) => {
  return (
    <svg
      className={`headshot ${props.raised ? 'headshot--raised' : ''}`}
      style={props.style}
      width='48'
      height='48'
      viewBox='0 0 24 24'
    >
      ...
      <g clipPath='url(#b)'>
        <defs>
          <path id='c' d='M-1121.33-2471.17h1680v3369h-1680z'/>
        </defs>
        <clipPath id='d'>
          <use overflow='visible'/>
        </clipPath>
        <path clipPath='url(#d)' d='M-278.33-22.17h76v76h-76z'/>
      </g>
